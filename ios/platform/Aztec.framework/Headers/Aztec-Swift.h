...
- (UITextWritingDirection)baseWritingDirectionForPosition:(UITextPosition * _Nonnull)position inDirection:(UITextStorageDirection)direction SWIFT_WARN_UNUSED_RESULT;
- (void)setBaseWritingDirection:(UITextWritingDirection)writingDirection forRange:(UITextRange * _Nonnull)range;
...
@property (nonatomic, strong) UIColor * _Nullable blockquoteBorderColor;
