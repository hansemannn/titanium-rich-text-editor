...
*/
@objcMembers class TiEditorKeyboardManager: NSObject {
    ...
    */
    func beginMonitoring() {
      NotificationCenter.default.addObserver(self, selector: #selector(TiEditorKeyboardManager.keyboardWillShowOrHide(_:)), name: UIResponder.keyboardWillShowNotification, object: nil)
      NotificationCenter.default.addObserver(self, selector: #selector(TiEditorKeyboardManager.keyboardWillShowOrHide(_:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
